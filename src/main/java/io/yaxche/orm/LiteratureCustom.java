...
@Entity ( name =  "litcurated" )
@Cacheable
public class LiteratureCustom extends PanacheEntityBase implements Serializable {
...
//    @Column( name = "\"ArticleTitle\"" )  
    ...
    public LiteratureCustom() {        
    }
    

    public LiteratureCustom( /*String LR_ID,*/ String articleTitle, String articleURL, String pubSource, String publishDate, String searchSource) {
        //this.LR_ID = LR_ID;
